...
import sys
sys.path.append('/Users/chanithas/Desktop/fyp/DiGress-guidance/')
...
def main(cfg: DictConfig):
    ...
    # Initializes the data module for the QM9 dataset, prepares the data for training, and retrieves training data SMILES strings
    # handling the QM9 dataset, including data loading and preprocessing.
    ...
    #this initializes either real or dummy extra features for the model. This allows for flexible experimentation with different input features to the model.
    ...
    # compute input and output dimensions based on the dataset and any extra features, then initialize training and 
    # sampling metrics and molecular visualization tools. 
    ...
    # Prepares keyword arguments for the model and attempts to resume from a checkpoint if specified. This includes loading the model configuration and the model itself.
